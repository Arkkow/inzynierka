            ...
            <Container>
                <Row>
                    <Form style={{display:"flex", alignItems:"center", flexDirection:"column"}}>
                        ...
                        {props.userid === props.user.id && (props.paymentstatus2 === "PENDING" || (props.paymentstatus === "NOTSTARTED" && props.partnerAcceptance === 1))?<paragraph_sb>Oczekuje na płatność partnera/rki</paragraph_sb>:null}
                        {props.partner === props.user.id && (props.paymentstatus === "PENDING" || props.paymentstatus === "NOTSTARTED")?<paragraph_sb>Oczekuje na płatność partnera/rki</paragraph_sb>:null}
                    </Form>
