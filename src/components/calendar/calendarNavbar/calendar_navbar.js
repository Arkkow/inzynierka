...
export const CalendarNavbar = (props) => {
    return (
        <div style={{background: "white", maxWidth: "50%", margin: "auto", padding: "1%", borderRadius: "1%"}}>

            <div style={{ display: "flex", justifyContent: "center", padding: "2%" }}>

                    <div style={{width: "100%"}}>
                        <div style={{ display: "flex", alignItems: "center"}} >OD</div>
                        <Form.Control type="date" placeholder="Start Date" style={{width: "80%", marginRight: "2%", marginLeft: "2%"}}/>
                    </div>
